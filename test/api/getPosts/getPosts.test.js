...
describe('Full Booking Path', () => {
  xit('verify multistep API workflow ', (done) => {
    ...
    let putResponse = chakram.put(url, body, options);
...
describe('Get all posts', () => {
  it('verify correct response for valid get post', async () => {
    let response = await chakram.get(
...
describe('Create Booking', () => {
  it('verify correct response when booking has been created', async () => {
    ...
    let res = await chakram.post(url, body, {
